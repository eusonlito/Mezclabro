...
<html lang="<?php $Gettext->getLanguage(); ?>">
    <head>
        <title><?php echo $Theme->meta('title').' - '.__('Mezclabro!'); ?></title>

        <meta http-equiv="Content-type" content="text/html; charset=utf-8" />

        <meta name="title" content="<?php __e('Mezclabro!'); ?>" />
        <meta property="og:title" content="<?php __e('Mezclabro!'); ?>" />
        <meta name="description" content="<?php __e('Play to Mezcladitos/WordCrack online!'); ?>" />
        <meta property="og:description" content="<?php __e('Play to Mezcladitos/WordCrack online!'); ?>" />
    ...
    <body>
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container">
                    <a class="brand" href="<?php echo BASE_WWW; ?>"><?php __e('Mezclabro!'); ?></a>
                    ...
                    <div class="nav-collapse">
                        <ul class="nav pull-left">
                            ...
                            <?php if (in_array(FILENAME, array('game.php', 'round.php')) && isset($game) && $game) { ?>
                            <li class="active"><a href="game.php?id=<?php echo $game; ?>"><?php __e('Game'); ?></a></li>
                            <?php } ?>
